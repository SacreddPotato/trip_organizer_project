      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSwitchTile('Push Notifications', 'Receive push alerts on your device.', pushEnabled, (v) => setState(() => pushEnabled = v)),
            _buildSwitchTile('Email Notifications', 'Receive trip updates via email.', emailEnabled, (v) => setState(() => emailEnabled = v)),
            _buildSwitchTile('App Updates', 'Get notified about new features.', updatesEnabled, (v) => setState(() => updatesEnabled = v)),
          ],
        ),
      ),
    );
